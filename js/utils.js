...
NexT.utils = {
  ...
  wrapImageWithFancyBox: function() {
    document.querySelectorAll('.post-body :not(a) > img, .post-body > img').forEach(element => {
      ...
      const $imageWrapLink = $image.wrap(`<a class="fancybox fancybox.image" style="border-bottom: 0px solid #999;" href="${imageLink}" itemscope itemtype="http://schema.org/ImageObject" itemprop="url"></a>`).parent('a');
